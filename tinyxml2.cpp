...
namespace tinyxml2
{
    ...
    */
    ...
    XMLNode::XMLNode(TinyXMLDocument *doc) : _document(doc),
                                         _parent(0),
                                         _value(),
                                         _parseLineNum(0),
    ...
    TinyXMLDocument::TinyXMLDocument(bool processEntities, Whitespace whitespaceMode) : XMLNode(0),
                                                                                _writeBOM(false),
    ...
    XMLError TinyXMLDocument::Parse(const char *xml, size_t nBytes)
    {
        Clear();
